...
const About = () => {
  ...
  return (
    <div className='w-full flex flex-col justify-center items-center text-white'>
      ...
      <div data-aos = 'fade-up' className='mt-10 bg-neutral-900 border-2 border-neutral-800 rounded-3xl p-10 w-[1200px] h-[800px] justify-center flex-col items-center flex gap-10'>
      ...
      <div className='w-full flex flex-col justify-center items-center'>
        ...
        <div data-aos = 'fade-up' className='mt-10 flex justify-center items-center gap-10 mb-20 flex-wrap w-[90%]'>
            <div className='bg-neutral-900 border-2 border-neutral-800 rounded-3xl p-5 w-[250px] h-[370px] flex flex-col justify-around items-center gap-6 shadow-2xl hover:scale-105 duration-500'>
      ...
      <div>
        ...
        <form data-aos = 'fade-up' className='flex flex-col justify-center items-center mt-10 mb-20'>
          <div className='bg-neutral-900 border-2 border-neutral-800 rounded-3xl p-10 w-[700px] h-[400px] flex flex-col justify-around items-center shadow-2xl'>
